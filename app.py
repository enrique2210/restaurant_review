...
from resources.cuisine_type import CuisineType, CuisineTypeList, cuisine_type_ns, cuisine_types_ns, CuisineTypeRegister
from resources.restaurant import Restaurant, RestaurantList, RestaurantRegister, restaurant_ns, restaurants_ns, \
