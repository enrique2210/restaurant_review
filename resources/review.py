...
review = reviews_ns.model('Review', {
    'restaurant_id': fields.Integer,
    'star': fields.Integer(5, min=1, max=5),
    'comment': fields.String(255),
    'date_visit': fields.Date(dt_format="mm-dd-YYYY", max=datetime.datetime.utcnow())
})
...
class ReviewRegister(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            if ReviewModel.find_by_restaurant_and_user(review_json['restaurant_id'], current_user.id):
